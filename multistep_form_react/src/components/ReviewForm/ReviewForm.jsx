...
const ReviwForm = ({data, updateFieldHandler}) => {
  return (
    <div className='review-form'>
        <div className="form-control score-container">
          ...
          <label className="radio-container">
            <input type="radio" name="review" value={"very_satisfied"} required checked={data.review === "very_satisfied"} onChange={(e) => updateFieldHandler("review", e.target.value)}/>
